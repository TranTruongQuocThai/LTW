    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipperApplications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShipperApplications_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShipperApplications_DeliveryAreas_DeliveryAreaId",
                        column: x => x.DeliveryAreaId,
                        principalTable: "DeliveryAreas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShipperProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShipperProfiles_DeliveryAreas_DeliveryAreaId",
                        column: x => x.DeliveryAreaId,
                        principalTable: "DeliveryAreas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipperApplications_DeliveryAreaId",
                table: "ShipperApplications",
                column: "DeliveryAreaId");

            migrationBuilder.CreateIndex(
                name: "IX_ShipperApplications_UserId",
                table: "ShipperApplications",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ShipperProfiles_DeliveryAreaId",
                table: "ShipperProfiles",
                column: "DeliveryAreaId");

            migrationBuilder.CreateIndex(
                name: "IX_ShipperProfiles_UserId",
                table: "ShipperProfiles",
                column: "UserId",
                unique: true);
